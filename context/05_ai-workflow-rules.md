...
- `apps/web/src/` — browser UI, React Router, and client integrations.
- `apps/api/src/` — Express API and server-side integrations.
- `apps/worker/src/` — Trigger.dev tasks and worker-side integrations.
